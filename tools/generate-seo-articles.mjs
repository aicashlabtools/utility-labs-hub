...
function footer() {
  return `<footer class="site-footer"><div class="footer-inner"><div><div class="footer-brand"><span class="logo-frame"><img src="/assets/ai-cash-lab-logo-600.png" alt="AI Cash Lab footer logo"></span><span>AI Cash Lab Tools</span></div><p class="footer-copy">Simple business tools for freelancers, creators, and digital service providers. Open a tool, run the numbers, and keep your workflow moving.</p></div><div><span class="footer-title">Popular Tools</span><div class="footer-links"><a href="/caption-line-splitter/">Caption Line Splitter</a><a href="/free-invoice-generator/">Free Invoice Generator</a><a href="/scope-creep-calculator/">Scope Creep Calculator</a></div></div><div><span class="footer-title">Explore</span><div class="footer-links"><a href="/">All Tools</a><a href="/creator-utilities/">Creator Utilities</a><a href="https://aicashlabofficial.gumroad.com" target="_blank" rel="noopener">Storefront Hub &rarr;</a></div></div></div><div class="copyright">&copy; 2026 AI Cash Lab. All Rights Reserved.</div></footer>`;
}
...
function indexHtml() {
  ...
  const card = (tool) => `<a class="card" href="/articles/${tool.slug}/"><div><span class="card-kicker">${esc(titleFromSlug(tool.tool))}</span><h2>${esc(tool.title)}</h2><p>${esc(tool.desc)}</p></div><strong>Read guide &rarr;</strong></a>`;
  ...
  const indexCss = `${css}.article-group{margin-top:34px}.group-heading{border-bottom:1px solid rgba(255,255,255,.08);padding-bottom:12px;margin-bottom:16px}.group-heading h2{color:#fff;font-size:1rem;text-transform:uppercase;letter-spacing:.12em;margin:0}.group-heading p{color:#64748b;font-size:13px;margin:4px 0 0}.grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:16px}.card{display:flex;min-height:235px;flex-direction:column;justify-content:space-between;background:#111827;border:1px solid rgba(255,255,255,.07);border-radius:12px;padding:20px;text-decoration:none;transition:transform .18s ease,border-color .18s ease,box-shadow .18s ease}.card:hover{transform:translateY(-2px);border-color:rgba(245,158,11,.35);box-shadow:0 18px 40px rgba(0,0,0,.24)}.card-kicker{display:block;color:#f59e0b;font-size:10px;font-weight:900;text-transform:uppercase;letter-spacing:.1em;margin-bottom:10px}.card h2{color:#fff;margin:0 0 10px;font-size:1.05rem;line-height:1.28}.card p{color:#a1a1aa;margin:0;font-size:.93rem}.card strong{margin-top:18px;color:#f59e0b;font-size:11px;font-weight:900;text-transform:uppercase;letter-spacing:.08em}@media(max-width:980px){.grid{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:640px){.grid{grid-template-columns:1fr}.card{min-height:0}}`;
