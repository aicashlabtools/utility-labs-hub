...
const styleTag='<link rel="stylesheet" href="../assets/standard-tool-closing-sections-v2.css">';
const scriptTag='<script src="../assets/standard-tool-closing-sections-v2.js" defer></script>';
...
for(const entry of await fs.readdir(root,{withFileTypes:true})){
  ...
  if(!html.includes('assets/standard-tool-closing-sections-v2.css'))html=html.replace('</head>',`${styleTag}</head>`);
  if(!html.includes('assets/standard-tool-closing-sections-v2.js'))html=html.replace('</body>',`${scriptTag}</body>`);
